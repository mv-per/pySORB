...
#include "../utils.h"
#include "files/pta_mixture.h"
#include "files/pta_pure.h"
#include <cassert>
#include <functional>
#include <string>
#include <vector>
...
public:
  /**
   * @brief Constructs a PotentialTheoryModels object and initializes the
   ...
   */
  PotentialTheoryModels(std::string potential, std::string equation_of_state,
  ...
  GetPureLoadingInvoker(std::string potential) override;
  ...
  GetMixtureLoadingInvoker(std::string potential) override;
